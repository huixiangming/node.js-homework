...
http.createServer(function(req,res){
  ...
  if(path=="/login"){
    ...
    req.on('data',function(pos){
      item.chapterId=chapterList.length+1;
      item.chapterName=qs.parse(pos).title;
      item.chapterDes=qs.parse(pos).content;
      item.chapterContent=qs.parse(pos).content;
      item.publishTimer= "2019-08-19";
      item.author="admin";
      item.views=1;
      item.imgPath='./login_bg.jpg';
